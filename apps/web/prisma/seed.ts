...
async function main() {
  ...
  const lark = await db.property.create({ data: {
    ...
    planSetKey: 'larkspur-2025', factsApprovedAt: days(-1), propertyType: 'Single-family detached', waterSource: 'Municipal', sewer: 'Septic, permitted 2025', floodZone: '[FEMA zone pending]', foundation: 'Slab on grade', lotDimensions: '93 ft × 80 ft (approx.)', parking: 'Attached 2-car garage · 2 driveway', fireplaces: 1,
